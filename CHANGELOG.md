...
- **`.claude/persona-config.json`**: `protectedPaths` drops the 5 entries for `hooks/scripts/lib/{agent-identity,microworld-rerun-core,microworld-queue,stop-gate-core,reviewer-route-gate-core}.sh` now that their raw appends are converted.
