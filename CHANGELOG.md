...
- **`docs/adr/0031-grill-with-docs-supersedes-grill-me-as-spec-master-control.md`** (new), **`docs/adr/0012-*.md`**: reciprocal `Amended by ADR-0031` marker.
