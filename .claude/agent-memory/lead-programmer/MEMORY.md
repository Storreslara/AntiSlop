...
- [gh348 protocol-trim plan tracking](project_gh348_protocol_trim_plan.md) — stale-test conflicts on reversed rulings; Affected-files lists can be wrong (Step 3) or cite stale line numbers (Step 5); adapters/codex/* is a `--update` blind spot
