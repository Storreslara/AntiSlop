...
- **Partly superseded (2026-09-24, covers this bullet and M7 below):**
  `docs/plans/2026-09-23-harness-integrity-gate-human-confirmation.md` gives
  five Set A/B paths a human-confirmation `ask` (never `allow`, never a
  subagent) in allowlisted main-session shapes; "no exemption" stays true.
